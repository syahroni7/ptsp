...
<div class="modal fade" id="fModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <form id="fForm" method="post" action="{{ route('syarat-layanan-master.store') }}"
                ...
                <div class="modal-body modalBox">
                    ...
                    <div class="row card-body">
                        <div class="col-12">
                            ...
                            <input type="hidden" name="id_master_syarat_layanan" id="id_master_syarat_layanan"
                                value="">
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-3 col-form-label">Nama Syarat Layanan</label>
                                <div class="col-sm-9">
