...
<div class="modal fade" id="fModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <form id="fForm" method="post" action="{{ route('syarat-layanan-list.store') }}"
                ...
                <div class="modal-body modalBox">
                    ...
                    <div class="row card-body">
                        <div class="col-12">
                            ...
                            <input type="hidden" name="array_id_master_syarat_layanan"
                                id="array_id_master_syarat_layanan">

                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-3 col-form-label">Nama Layanan</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="Nama Layanan" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select name="id_unit_pengolah" id="id_unit_pengolah"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select name="id_jenis_layanan" id="id_jenis_layanan"
                                        class="form-control select2 disabled">
                            ...
                            <div class="row mb-3 div-json">
                                ...
                                <div class="col-md-9">
                                    <select name="id_calon_jemaah" id="search-syarat"
                                ...
                                <div class="col-md-12 mt-3 table-responsive">
                                    ...
                                    <table class='table table-bordered display mt-3 responsive' id="jsonTbl"
