                ...
                <div class="col-lg-6">
                    <div class="card" id="find-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-2">
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="pemohon_no_hp" id="lacak-pemohon-no-hp" placeholder="Masukkan No HP saat mendaftar">
...
@section('_scripts')
    ...
    <script>
        ...
        function searchData(id_pelayanan, pemohon_no_hp) {
            $('body').block({
                message: `Loading...`
            });
            ...
            setTimeout(function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/publik/lacak-pelayanan/' + id_pelayanan + '/' + pemohon_no_hp,
