...
<head>
    ...
    <title>Pelayanan Terpadu Satu Pintu - KemenagPessel</title>
...
<body class="page-index">
    ...
    <section id="hero" class="hero d-flex align-items-center">
        <div class="container">
            <div class="row">
                <div class="col-xl-4">
                    <h2 data-aos="fade-up">PTSP KEMENAG PESSEL</h2>
                    <blockquote data-aos="fade-up" data-aos-delay="100">
                        <p>Pelayanan Terpadu Satu Pintu Kementerian Agama Kabupaten Pesisir Selatan. </p>
                    </blockquote>
        ...
        <section id="why-us" class="why-us">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row g-0" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-xl-5 img-bg" style="background-image: url('{{ asset('nova-assets/img/why-us-bg.jpg') }}')"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 position-relative" data-aos="fade-up" data-aos-delay="200">
                        <div class="phone-wrap">
                            <img src="{{ asset('nova-assets/img/iphone.png') }}" alt="Image" class="img-fluid">
                        </div>
                    </div>
                </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-5">
                    ...
                    <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="post-box">
                            <div class="post-img"><img src="{{ asset('nova-assets/img/blog/blog-1.jpg') }}" class="img-fluid" alt=""></div>
                            <div class="meta">
                    ...
                    <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="post-box">
                            <div class="post-img"><img src="{{ asset('nova-assets/img/blog/blog-2.jpg') }}" class="img-fluid" alt=""></div>
                            <div class="meta">
                    ...
                    <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="post-box">
                            <div class="post-img"><img src="{{ asset('nova-assets/img/blog/blog-3.jpg') }}" class="img-fluid" alt=""></div>
                            <div class="meta">
                    ...
                    <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
                        <div class="post-box">
                            <div class="post-img"><img src="{{ asset('nova-assets/img/blog/blog-4.jpg') }}" class="img-fluid" alt=""></div>
                            <div class="meta">
