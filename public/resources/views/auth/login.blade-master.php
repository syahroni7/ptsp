...
<head>
    ...
    <title>Login - PTSP Kemenag Lebak</title>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="index.html" class="logo d-flex align-items-center w-auto">
                                    ...
                                    {{-- <span class="d-none d-md-block">PTSP Kemenag Lebak</span> --}}
                                    <span class="d-none d-xs-none d-sm-none d-md-none d-lg-block d-xl-block text-white">PTSP Kantor Kementerian Agama Kabupaten Lebak</span>
                                    <span class="d-none d-xs-block d-sm-block d-md-block d-lg-none d-xl-none text-white">PTSP Kemenag Lebak</span>
                                </a>
                            </div><!-- End Logo -->
